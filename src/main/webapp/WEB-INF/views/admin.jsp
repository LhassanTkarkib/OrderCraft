<%@ page import="com.jetbrains.ordercraft2.Model.Classes.User" %>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/Css/admincss.css">
    <style>
        .articlecenter {
            text-align: center;
            font-size: 20px;
...
<header class="page-header">
    <nav>
        ...
        <ul class="admin-menu">
            ...
            <li>
                <a onclick="location.href='${pageContext.request.contextPath}/admin?action=manageProducts'">
                    <svg>
            ...
            <li>
                <a onclick="location.href='${pageContext.request.contextPath}/admin?action=manageUsers'">
                    <svg>
            ...
            <li>
                <a onclick="location.href='${pageContext.request.contextPath}/admin?action=manageOrders'">
                    <svg>
...
<section class="page-content">
    ...
    <section class="grid">
        ...
        <article>
            <div class="action-button add-button">Add Product</div>
            <div class="action-button show-button">Show Products</div>
            <div class="action-button delete-button">Delete Product</div>
            <div class="action-button update-button">Update Product</div>
        </article>
        ...
        %>
        <article>
            <div class="action-button add-button" onclick="showAddUserForm()">Add User</div>
            <div class="action-button show-button"
                 onclick="location.href='${pageContext.request.contextPath}/DisplayUsersServlet'">Show User
            </div>
            <div class="action-button delete-button" onclick="showDeleteForm()">Delete User</div>
            <div class="action-button update-button" onclick="showUpdateForm()">Update User</div>
        ...
        <% } %>
            ...
            <div id="deleteClientForm" style="display: none;">
                <article>
            ...
            <div id="updateClientForm" style="display: none;">
                <article>
                <form action="${pageContext.request.contextPath}/UpdateUserServlet" method="POST">
                    <label for="id">Enter User's id :</label>
                    <input type="id" id="id" name="id" required>
                    <label for="name">Enter User new Name:</label>
                    <input type="text" id="name" name="name" required>
                    <label for="email">Enter User's New Email:</label>
                    <input type="email" id="email" name="email" required>
        ...
        %>
        <article>
            <div class="action-button add-button">Add Order</div>
            <div class="action-button show-button">Show Orders</div>
            <div class="action-button delete-button">Delete Order</div>
            <div class="action-button update-button">Update Order</div>
        </article>
        <%
                break;
            default:
        ...
        %>
        <article class="articlecenter"> Welcome , please select from the slidebar what to manage</article>
        <%
                }
            }
        %>
...
<script>
    ...
    function showDeleteForm() {
        document.getElementById("deleteClientForm").style.display = "block";
    }
